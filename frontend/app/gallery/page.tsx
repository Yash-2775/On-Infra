        ...
        <Container>
          <div className="text-center mb-12">
            ...
            <p className="mt-2 text-dark-muted text-sm sm:text-base max-w-xl mx-auto">
              Proud to deliver engineering, security surveillance, and infrastructure solutions for leading organizations.
            </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
            {CLIENTS_LIST.map((client, index) => (
              <FadeUp key={client.id} delay={index * 0.04}>
                <div className="flex flex-col items-center justify-between p-5 bg-white rounded-2xl border-2 border-gray-200/90 hover:border-primary/50 transition-all duration-300 hover:scale-105 shadow-xs hover:shadow-md h-[160px] text-center group">
                  {/* Top Logo Container */}
                  ...
                  <span className="text-xs sm:text-sm font-semibold font-poppins text-dark group-hover:text-primary transition-colors line-clamp-1 mt-auto pt-2 border-t border-gray-100 w-full">
                    {client.name}
                  </span>
                </div>
              </FadeUp>
